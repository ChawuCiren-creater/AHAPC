...
class GRU(nn.Module):
    def __init__(self, input_size=2324, hidden_size=128, output_size=1, dropout_rate=0.5):
...
checkpoint_path = "2324_GRU_best_model.pt"
...
print(scaler)
model.eval()
test_csv_file = "ESM2_650M+PSSM_AAC+ProtT5_Full_test.csv"
